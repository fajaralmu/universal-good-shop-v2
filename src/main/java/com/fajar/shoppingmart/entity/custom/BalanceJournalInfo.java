...
@Data
public abstract class BalanceJournalInfo<T extends FinancialEntity> implements Serializable {
	/**
	 * 
	 */
	...
	protected final T financialEntity;
	
	public BalanceJournalInfo(T financialEntity) {
